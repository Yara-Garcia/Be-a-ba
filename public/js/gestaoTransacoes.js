    ...
    .then(data => {
        if (data.success) {
            ...
            transactions.forEach(transaction => {
                ...
                thNome.id = "row";
                thNome.textContent = transaction.nome_transacao;

                thNome.setAttribute('transaction-id', transaction.id_transacao);
            ...
            function filtrarTabela(filtro) {
                ...
                linhas.forEach(linha => {
                    const nomeTransacao = removerAcentos(linha.querySelector('.col-name').textContent.toLowerCase()); // Normaliza e converte para minúsculas
