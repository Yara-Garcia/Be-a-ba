                ...
                .then(data => {
                    if (data.success) {
                        ...
                        modules.forEach(module => {
                            ...
                            tdNome.textContent = module.nome_modulo;

                            tdNome.setAttribute('module-id', module.id_modulo);
                            ...
                            if (tipoUsuario === 'admin') {
                                ...
                                deletarIcon.setAttribute('module-id', module.id_modulo);
                        ...
                        function filtrarTabela(filtro) {
                            ...
                            linhas.forEach(linha => {
                                const nomeModulo = removerAcentos(linha.querySelector('.col-name').textContent.toLowerCase());
